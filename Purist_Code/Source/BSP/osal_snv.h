 ...
 *
 * @return  ERROR_SUCCESS if initialization succeeds. ERROR_FAILURE, otherwise.
 */
 ...
 * @fn      osal_snv_reset
 *
 * @brief   Rest Nv aread & Initialize NV service.
 *
 * @return  ERROR_SUCCESS if initialization succeeds. ERROR_FAILURE, otherwise.
 */
extern uint8 osal_snv_reset( void );
 ...
 *
 * @return  ERROR_SUCCESS if successful, NV_OPER_FAILED if failed.
 */
 ...
 *          ERROR_INVALIDPARAMETER if threshold invalid.
 */
